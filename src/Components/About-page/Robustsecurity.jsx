  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="w-full h-3/4 mt-12 flex justify-center align-middle block lg:hidden ">
        <img data-aos ="fade-up"  className="" src={security} alt="" />
      </div>
        {/* <img className="max-h-2/4" src={missionpic} alt="" /> */}
        <div className="flex flex-col md:flex-row lg:flex-row flex-wrap gap-4 lg:gap-2">
          {data.map((item, index) => (
            <div key={index} className="flex flex-col gap-3 w-full md:w-[45%] lg:w-[45%] m-1">
